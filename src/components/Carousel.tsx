  ...
  return (
    <div className="h-full w-full rounded-xl shadow">
      <div className="relative h-full w-full">
        ...
        <button className="group absolute top-1/2 left-2 z-10 rounded-full bg-white/10 p-0 transition hover:bg-white/50">
          <svg
        ...
        <button className="group absolute top-1/2 right-2 z-10 rounded-full bg-white/10 p-0 transition hover:bg-white/50">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 text-white transition group-hover:text-gray-800"
            fill="none"
