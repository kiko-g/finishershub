  ...
  return (
    <div className="h-full w-full rounded-xl shadow">
      <div className="group relative h-full w-full">
        ...
        <button className="invisible absolute top-1/2 left-2 z-10 rounded-full bg-black/40 p-0.5 transition hover:bg-primary/75 group-hover:visible">
          <svg
        ...
        <button className="invisible absolute top-1/2 right-2 z-10 rounded-full bg-black/40 p-0.5 transition hover:bg-primary/75 group-hover:visible">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 text-white"
            fill="none"
