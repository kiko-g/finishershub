      ...
      <div className="mt-6 rounded bg-lightest px-4 py-4 text-base dark:bg-dark lg:px-8 lg:py-8 lg:text-xl">
        <ul className="flex flex-col gap-y-4">
          ...
          <li>
            ...
            acts like the home page with a twist: instead of a museum you can view a random new highlight by pressing
            the arrows. It's called casino because it acts like a slot machine of finishing moves.
          </li>
          ...
          <li>
            ...
            <strong>600 clips</strong>. However, they only capture around <strong>10%</strong> of all the finishing
            moves performed by Finishers Club as of September 2021.
          </li>
