...
export function AccessBadge() {
  ...
  return locked ? (
    ...
    <div className="flex items-center gap-2">
      <button
        onClick={() => setFolded(!folded)}
        className="flex items-center justify-center gap-x-1 rounded border border-teal-500 bg-teal-500/60 px-3 py-2 text-white transition-all hover:bg-teal-500 lg:px-2 lg:py-1.5"
      >
