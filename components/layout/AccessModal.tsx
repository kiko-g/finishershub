  ...
  return (
    <>
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-x-1 rounded border border-emerald-600 bg-emerald-600/70 px-1.5 py-1.5 text-center text-xs text-white transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50 dark:border-emerald-600 dark:bg-emerald-600/50 lg:px-2 lg:py-1.5 lg:text-sm"
      >
