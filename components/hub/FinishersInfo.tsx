...
export default function FinishersInfo({}: Props) {
  return (
    <div className="flex rounded border border-slate-200 bg-sky-50 px-8 py-8 dark:border-slate-300/10 dark:bg-slate-800/50">
      <svg
        aria-hidden="true"
        viewBox="0 0 32 32"
        fill="none"
        ...
        <div className="prose prose-a:text-sky-900 prose-code:text-sky-900 dark:prose-code:text-slate-300 mt-2.5 font-normal text-sky-800 [--tw-prose-background:theme(colors.sky.50)] dark:text-slate-300">
          ...
          <ul className="mt-1 ml-5 flex list-decimal flex-col gap-y-1 lg:gap-y-0.5">
            ...
            <li>
              ...
              that is performed on players laying prone. This is especially tasty to any lover of
              finishing moves, as your opponent is caught lacking to the extreme.
            </li>
          </ul>
        </div>
      </div>
