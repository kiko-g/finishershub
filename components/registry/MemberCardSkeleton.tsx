      ...
      <section className="relative flex w-auto grow flex-col justify-between space-y-6 rounded-r-xl px-1 py-1 text-base font-normal lg:h-auto lg:max-h-full lg:w-3/4 lg:py-0 lg:pl-4 lg:pr-0">
        <div className="flex h-48 flex-col justify-between">
          ...
          <div className="flex items-center gap-2">
            <button className="inline-flex h-8 w-20 animate-pulse items-center space-x-2 rounded bg-lightish p-2 text-center text-sm font-medium text-white transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-darkish"></button>
            <button className="inline-flex h-8 w-20 animate-pulse items-center space-x-2 rounded bg-lightish p-2 text-center text-sm font-medium text-white transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-darkish"></button>
            <button className="inline-flex h-8 w-20 animate-pulse items-center space-x-2 rounded bg-lightish p-2 text-center text-sm font-medium text-white transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-darkish"></button>
          </div>
        </div>
