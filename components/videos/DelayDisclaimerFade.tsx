  ...
  return shown ? (
    <div
      ...
      className={classNames(
        ...
        type === 'info'
          ? `border-cyan-600/90 bg-cyan-600/80 dark:border-cyan-500/40 dark:bg-cyan-500/40`
          : ``,
        type === 'error'
          ? `border-rose-600/90 bg-rose-600/80 dark:border-rose-500/40 dark:bg-rose-500/40`
          : ``,
        type === 'warning'
          ? `border-amber-600/90 bg-amber-600/80 dark:border-amber-500/40 dark:bg-amber-500/40`
          : ``,
        type === 'success'
          ? `border-teal-600/90 bg-teal-600/80 dark:border-teal-500/40 dark:bg-teal-500/40`
          : ``,
        type === undefined || type === ''
      ...
      <div className="flex w-full items-center justify-between">
        ...
        <p className="ml-3 flex-1 text-sm font-normal tracking-tight lg:font-normal lg:tracking-normal">
          {type === 'success' ? (
            ...
            <span>
              Fetching clips... Loading stage takes some time if you haven&apos;t been on the
              website recently or if the results are not cached.
            </span>
          ) : (
            <span>
